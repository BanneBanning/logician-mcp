                ...
                inputSchema: [
                    ...
                    "properties": [
                        ...
                        "hold_ms": [
                            ...
                            "description": "How long a press/select/mute/solo/vpot_press holds the button down. Default 0, and 0 is the MEASURED default: holds from ~0.2 ms to 50 ms were all honoured, 16 of 16, with the same 102-106 ms echo. Pass one only for Logic Control's hold behaviours, which are unswept."
                        ],
