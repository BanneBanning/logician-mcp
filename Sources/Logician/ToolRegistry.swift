            ...
            Tool(
                ...
                inputSchema: [
                    ...
                    "properties": [
                        ...
                        "tolerance_db": ["type": "number", "description": "Accepted deviation from the target, default 0.15 dB. `verified` means this number and nothing wider, on both routes (it used to accept max(tolerance_db, 0.6) dB on the control-surface fast path and call that verified; that floor is gone)."]
                    ],
                    "required": ["track_name"],
                    "additionalProperties": false
                ],
