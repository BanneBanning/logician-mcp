...
Parameters:
  ...
  - `include_audio` (boolean): Attach the rendered audio as MCP audio content blocks, default true — see AUDIO RESULTS in the server instructions before passing false.
